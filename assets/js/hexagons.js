$().ready(function() { //Add class to parent element to margin properly
    ...
    //reddit
    jQuery(".hb .fa-reddit-alien").parent().addClass("hb-reddit");
    jQuery(".hb.inv .fa-reddit-alien").parent().addClass("hb-reddit-inv").removeClass("hb-reddit");

    //vk
    jQuery(".hb .fa-vk").parent().addClass("hb-facebook");
    jQuery(".hb.inv .fa-vk").parent().addClass("hb-facebook-inv").removeClass("hb-facebook");

    //mail
    jQuery(".hb .fa-envelope-o").parent().addClass("hb-google-plus");
    jQuery(".hb.inv .fa-envelope-o").parent().addClass("hb-google-plus-inv").removeClass("hb-google-plus");

    //graduation-cap
    jQuery(".hb .fa-graduation-cap").parent().addClass("hb-xing");
    jQuery(".hb.inv .fa-graduation-cap").parent().addClass("hb-xing-inv").removeClass("hb-xing");

    //calendar
    jQuery(".hb .fa-calendar").parent().addClass("hb-twitter");
    jQuery(".hb.inv .fa-calendar").parent().addClass("hb-twitter-inv").removeClass("hb-twitter");
